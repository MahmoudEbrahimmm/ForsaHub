            ...
            <div class="col-md-10 m-auto">
                <div class="d-flex justify-content-between align-items-center mt-5 mb-3">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('dashboard.applications.edit', $application->id) }}" class="btn btn-success">
                ...
                <table class="table bg-white p-3 rounded shadow-sm">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($application->resume && $application->resume->file_url)
                                    <a href="{{ url('upload/' . $application->resume->file_url) }}" target="_blank" class="btn btn-sm btn-primary">
                                        Download CV
                                    </a>
                                @else
                                    No Resume
